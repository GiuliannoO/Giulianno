...
client.on('ready', () => { /*var channel = client.channels.get('167715230082662401'); channel.sendMessage("**O BoT está online!**").then(msg => {msg.delete(60000)});*/ require('./events/ready.js')(client, message) }); 
