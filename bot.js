...
client.on('message', message => { 
  ...
  if (msgbanida.includes('PPPPP','NNNNN')) { message.delete(); message.channel.send('**'+message.author.username+'**, A sua mensagem foi deletada. Por favor não diga palavrões!!! Rhrumnn!!!').then(msg => {msg.delete(60000)}); }
  //MENSAGEM REQUIRE
