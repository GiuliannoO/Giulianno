...
//READY
client.on('ready', () => { var interval = setInterval (function () { var channel = client.channels.get('167715230082662401'); channel.sendMessage(":black_square_button: **Mensagem automática:** Olá! Eu me chamo **@Waifu** e sou a Bot deste dervidor \nSou programada e hosteada pelo admin **@Giulianno** \n● Use o comando **!bot** para chamar a minha atenção \n● Use o comando **!ajuda** para listar os comandos usados no servidor \n● Eu aconselho você a **diminuir** o volume do meu áudio \n( Click direito em mim **@Waifu** e ajustar o volume do usuário. Obrigada ) ").then(msg => {msg.delete(600000)})}, 3600000); require('./events/ready.js')(client) }); 

//GUILD
client.on('guildCreate', guild => require('./events/guildCreate.js')(client, guild));
client.on('guildMemberAdd', (member, message, channel) => { var channel = client.channels.get('167715230082662401'); channel.sendMessage('Olá, seja bem vindo(a) **'+member.user.username+'** ao servidor! ... **um conselho** ... Por favor, **diminuir** o volume do meu áudio! ( Click direito em mim **@Waifu** e ajustar o volume do usuário. Obrigada )').then(msg => {msg.delete(60000)}) } );
