...
client.on('guildMemberUpdate', (oldMember, newMember) => { newMember.guild.defaultChannel.sendMessage('O usuário '+member.user.username+' atualizou os seus dados!').then(msg => {msg.delete(60000)}) } );
