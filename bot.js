...
//READY
client.on('ready', () => { var interval = setInterval (function () { var channel = client.channels.get('167715230082662401'); channel.sendMessage(":black_square_button: **Mensagem automática:** Olá! Eu sou a **BoT** **@Waifu**! \nSou programada e hosteada pelo **@Giulianno** para cuidar deste servidor! \n● Por favor, **diminuir** o volume do meu áudio ( Click direito em mim **@Waifu** e ajustar o volume do usuário ) \n● Use o comando **!bot** para chamar a minha atenção \n● Use o comando **!ajuda** para listar os comandos usados no servidor \n● Use o comando **!invite** para criar um link e invitar um novo usuário para o servidor \n( Mande o link para a pessoa desejada ) \n( Apenas usuários com o status de **@Membro** podem usar o comando **!invite**. Por favor, peça para algum **Admin** mudar o seu status para **@Membro** )").then(msg => {msg.delete(600000)})}, 3600000); require('./events/ready.js')(client) }); 

//GUILD
client.on('guildCreate', guild => require('./events/guildCreate.js')(client, guild));
client.on('guildMemberAdd', (member, message, channel) => { var channel = client.channels.get('167715230082662401'); channel.sendMessage('Olá, seja bem vindo(a) **'+member.user.username+'** ao servidor! ... **um conselho** ... Por favor, **diminuir** o volume do meu áudio! ( Click direito em mim **@Waifu** e ajustar o volume do usuário )').then(msg => {msg.delete(60000)}) } );
