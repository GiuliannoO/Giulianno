...
module.exports = async (client, message, args) => { 
    ...
    const reactions = await msgg.awaitReactions(reaction => reaction.emoji.name === sim || reaction.emoji.name === nao, {time: 60000}).then(function (message) { message.delete(66000); }).catch(function() {   });
